...
//        users wheel_spins ai_usage mailboxes articles shares recycle_bin archives
// 行为：所有增删改自动写 archives 存档；delete 先入 recycle_bin 再删源行
// ============================================================

const TABLES = ['orders','messages','gallery','products','crystals','records','subscribers','settings','app_data','users','wheel_spins','ai_usage','mailboxes','articles','shares','recycle_bin','archives'];
const corsHeaders = {
